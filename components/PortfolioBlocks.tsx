                        ...
                        <>
                          <Link href={`/post${item.LINK}`}>
                            <div
                              ...
                              className="cursor-pointer relative w-full sm:mt-0 mt-4 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                            >
                              <div>
                                ...
                                <div className="absolute bottom-0 left-0 p-6">
                                  <h2
                                    className={`text-xl font-semibold 5 ${
